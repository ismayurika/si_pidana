...
<html>
    <head>
        <title>Cetak Data Pidana Khusus</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PIDANA KHUSUS</h3>
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
								<tr>
                                    <td>Nomor Perkara</td> <td><?= $data['nomor_terpidana'] ?></td>
                                </tr>
                                <tr>
								...
								<tr>
                                    <td>Tempat Kejadian</td> <td><?= $data['tmpt_kejadian'] ?> hari</td>
                                </tr>
